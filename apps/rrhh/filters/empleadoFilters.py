...
class EmpleadoFilterForm(helper.FormHelper):
    def __init__(self, *args, **kwargs):
        ...
        bLimpiar = '<a class="btn btn-sm btn-secondary btn-icon-split" href="' + reverse('empleado:list') + '"><span class="icon text-white-50"><i class="fas fa-undo"></i></span><span class="text">Limpiar</span></a>'
