...
def actions_allowed_denuncia_art():
    ACTIONS = '''
    {% if perms.denuncia_art.view_denuncia_art %} 
    <a href="{% url 'denuncia:detail' record.pk %}" class="text-info" data-toggle="tooltip" data-original-title="Ver"><i class="fa fa-eye">&nbsp;</i></a>
    {% endif %}

    {% if perms.denuncia_art.change_denuncia_art %} 
    <a href="{% url 'denuncia:update' record.pk %}" class="text-primary" data-toggle="tooltip" data-original-title="Editar"><i class="fa fa-edit">&nbsp;</i></a>
    {% endif %}

    {% if perms.denuncia_art.delete_denuncia_art %} 
    <a href="{% url 'denuncia:delete' record.pk %}?next={{request.get_full_path|urlencode}}" class="text-danger" data-toggle="tooltip" data-original-title="Eliminar"><i class="fa fa-trash">&nbsp;</i></a>
    {% endif %}
    '''
    return ACTIONS
...
class DenunciaTable(tables.Table):
    ...
    actions = tables.TemplateColumn(template_code=actions_allowed_denuncia_art(), \
